...
git clone https://github.com/4urie/My-Portfolio.git
...
The project is available on [GitHub](https://github.com/4urie/My-Portfolio) under the MIT License. Contributions, feedback, and feature requests are welcome!
