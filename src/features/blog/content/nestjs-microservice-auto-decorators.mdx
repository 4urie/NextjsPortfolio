...
The package is fully open source and available on both [NPM](https://www.npmjs.com/package/nestjs-microservice-auto-decorators) and [GitHub](https://github.com/4urie).
